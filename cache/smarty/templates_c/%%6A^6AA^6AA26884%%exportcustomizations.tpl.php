<?php /* Smarty version 2.6.33, created on 2022-09-12 16:29:50
...
><?php endif; ?><?php echo $this->_tpl_vars['moduleList'][$this->_tpl_vars['k']]; ?>
            ...
            <TD VALIGN="top">
            <?php $_from = $this->_tpl_vars['i']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
